...
<body>
  ...
  $u_username = $u_password = $u_name = $u_address = $u_language = $u_age = $u_email = $u_phone = $gender = $userType = "";
  ?>

  <div id="bigText"> Make An Account</div>
  		<br>
  		<!--<p><span class="error">* required field.</span></p>-->
  		<form class="bookFormClass" action = "php/createAccount2.php" method="post" enctype="multipart/form-data">
        ...
        Email: <input type="text" name="u_email" required value="<?php echo $u_email;?>" >
  			<br><br>
        Phone Number (No dashes): <input type="text" name="u_phone" required value="<?php echo $u_phone;?>" >
  			<br><br>
        ...
        <input type="radio" name="userType" <?php if (isset($userType) && $userType=="Volunteer") echo "checked";?> required value="Volunteer">Volunteer
  			<br><br>
        Preffered Contact: <input type="text" name="u_pcontact" required value="<?php echo $u_pcontact;?>" >
        <br><br>
